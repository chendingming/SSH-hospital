...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="OrderAction_getByDoctor" class="sidebar-link text-muted active"><i class="o-sales-up-1 mr-3 text-gray"></i><span>总预约表</span></a></li>
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-uppercase mb-0">总预约</h6>
                            </div>
                            <div class="card-body">
                                <table class="table card-text table-sort">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>预约单号</th>
                                    ...
                                    <c:forEach items="${orderList}" var="order">
                                        <tr>
                                            ...
                                            <c:if test="${order.state==0}">
                                                <td class="td-struts">
                                                    <span class="label label-warning radius">未就诊</span>
                                                </td>
                                            </c:if>
...
<!-- JavaScript files-->
<script src="${pageContext.request.contextPath}/admin/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
